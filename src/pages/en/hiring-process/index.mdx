...
As you might imagine, it's very hard for the Recruiter to go through all those resumes and filter them down to just a handful. They've come up with tricks to find the best applicants as quickly as possible and [we've got tips for you to **not** get filtered out](/en/common-ideas/recruiters-are-busy/).
