...
The resume you give to a potential employer should fit into a single page. Some recruiters simply ignore the second page, so keep it to one page. If you have more experience that can fit on a single page, use [LinkedIn](https://linkedin.com) as your extended resume and be sure to reference it as part of your contact information.
