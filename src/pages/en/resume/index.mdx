...
Common reasoning for insisting on perfect spelling is that the job being applied for requires precision and attention to details so it "makes sense" to insist that resumes get submitted in very good form. 
