...
It's now less repetitive, but [verbs like "was" and "did" don't convey action as well as other verbs could](./tips/action-words). We'd like to use action words like "Guided," "Taught" and "Aided." The first sentence is actually just a job title, meaning it doesn't need to to be a sentence at all.
